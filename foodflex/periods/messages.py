...
async def on_message(message):
    ...
    if len(message.attachments) == 0 and (hour >= 00 and hour < 12) and message.channel == voting_channel and (len(str(message.clean_content)) == 1 or message.clean_content == ':b:'): # VOTING
